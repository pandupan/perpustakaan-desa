        ...
        <div className="flex flex-row justify-center items-center">
          <Tabs defaultValue="account" className="w-full">
            ...
            <TabsList>
              ...
              <TabsTrigger value="sedangdipinjam">3 Sedang dipinjam</TabsTrigger>
              <TabsTrigger value="telahdipinjam">7 Telah dipinjam</TabsTrigger>
            </TabsList>
            </div>
            <TabsContent value="tanda"> 
              <div className="flex flex-row flex-wrap mx-auto items-center bg-white justify-center w-full rounded-xl shadow-lg px-20 mt-4 py-8">
